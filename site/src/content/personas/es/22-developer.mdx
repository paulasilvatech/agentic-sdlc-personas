...
| [Azure MCP Server](https://github.com/Azure/azure-mcp) | Oficial (Microsoft) | Traer errores de Application Insights y Azure Monitor al loop de fix-bug; consultar recursos Azure durante la implementación |
| [Azure DevOps MCP Server](https://github.com/microsoft/azure-devops-mcp) | Oficial (Microsoft) | Leer el work item activo en Azure Boards y actualizarlo tras el merge del PR (cuando el equipo usa Azure DevOps en lugar de GitHub Issues) |
| [Microsoft 365 Agents SDK MCP](https://learn.microsoft.com/microsoft-365/agents-sdk/) | Oficial (Microsoft) | Integrar la feature con Teams, Copilot y otras superficies de Microsoft 365 cuando el producto lo requiera |
