...
|-----|--------|---------------------|
| [GitHub MCP Server](https://github.com/github/github-mcp-server) | Official | Read the repo, manage PRs and issues, read Actions runs |
| [Microsoft Learn Docs MCP](https://github.com/microsoftdocs/mcp) | Official | Fetch current Microsoft documentation when implementing on Azure stacks |
| [Azure MCP Server](https://github.com/Azure/azure-mcp) | Official (Microsoft) | Pull Application Insights and Azure Monitor errors into the fix-bug loop; query Azure resources during implementation |
| [Azure DevOps MCP Server](https://github.com/microsoft/azure-devops-mcp) | Official (Microsoft) | Read the active work item from Azure Boards, update it after PR merge (when the team uses Azure DevOps instead of GitHub Issues) |
| [Playwright MCP](https://github.com/microsoft/playwright-mcp) | Official (Microsoft) | Drive end-to-end tests against the running feature |
| [Microsoft 365 Agents SDK MCP](https://learn.microsoft.com/microsoft-365/agents-sdk/) | Official (Microsoft) | Integrate the feature with Teams, Copilot, and Microsoft 365 surfaces when the product requires it |
