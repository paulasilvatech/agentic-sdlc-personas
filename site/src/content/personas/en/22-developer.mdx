...
| [Sentry MCP Server](https://github.com/getsentry/sentry-mcp) | Official | Pull the error context into the fix-bug loop |
| [Snyk MCP Server](https://docs.snyk.io/scan-with-snyk/snyk-mcp) | Official | Check vulnerabilities on dependency upgrade and during refactor |
| [Linear MCP Server](https://linear.app/docs/mcp) | Official | Read the active ticket, update the issue after PR merge |
| [Figma Dev Mode MCP](https://developers.figma.com/docs/figma-mcp-server/) | Official | Pull design tokens and component specs when implementing UI features |
